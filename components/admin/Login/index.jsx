...
export default function LoginComponent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col  py-12 sm:px-6 lg:px-8">
      ...
      {/* <Image src="/logos/login-logo.png" alt="admin logo"  width="140" height="90"/> */}
        <h2 className="text-center text-3xl font-extrabold text-gray-900">
          Sign in to your admin account
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
        This is only for admitters 
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            {errors.apiError && (
              <div className="bg-rose-50 text-sm font-medium text-rose-700 mt-3 mb-0 text-center p-4">
            ...
            <div className="flex items-center justify-between pt-3">
              <div className="flex items-center">
                ...
                >
                  {isLogin ? "Create account" : <><ArrowNarrowLeftIcon className="h-6 w-5 text-blue-500 mr-2" />{"Login"}</>}
                </a>
              </div>
