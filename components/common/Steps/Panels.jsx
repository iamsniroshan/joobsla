...
export default function PanelSteps(props) {
  const {steps} = props
  return (
          ...
          <li key={step.headerText} className="relative md:flex-1 md:flex">
            {step.status === 'complete' ? (
              ...
              <a href={step.href} className="px-6 py-2 flex items-center text-sm font-medium" aria-current="step">
                ...
                <span className="ml-4 text-sm font-medium text-indigo-600">{step.headerText}</span>
              </a>
            ) : (
              <a href={step.href} className="group flex items-center">
                <span className="px-6 py-2 flex items-center text-sm font-medium">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">{step.headerText}</span>
                </span>
              </a>
            )}
