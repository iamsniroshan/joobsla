...
const item = [
  { category: 'Published', title: 'This job posting can be viewed by anyone who has the link.', current: true },
  { category: 'Draft', title: 'This job posting will no longer be publicly accessible.', current: false },
]
...
export default function Example() {
  ...
  <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
    <li x-for="item in items">
      <a class="hover:bg-light-blue-500 hover:border-transparent hover:shadow-lg group block rounded-lg p-4 border border-gray-200">
        <dl class="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-center">
          ...
          <div class="col-start-2 row-start-1 row-end-3">
            ...
            <dd class="flex justify-end sm:justify-start lg:justify-end xl:justify-start -space-x-2">
              <img x-for="user in item.users" width="48" height="48" class="w-7 h-7 rounded-full bg-gray-100 border-2 border-white" />
            </dd>
          </div>
        </dl>
      </a>
