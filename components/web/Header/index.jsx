      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-0">
          <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
            ...
            <div className="hidden lg:block min-w-0 flex-1 md:px-8 lg:px-0 xl:col-span-5">
            ...
            <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
              ...
              {loading === 'unauthenticated' && (
                <>
                  ...
                  >
                    <button className="block text-md mr-4 shadow bg-teal-500 border-teal-500 text-white hover:border-transparent focus:outline-none  hover:text-black  py-1 px-10 rounded font-bold cursor-hand">Log In</button>
                  </Link>
                </>
              )}
            </div>
